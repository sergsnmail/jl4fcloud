...
public class FileDataSourceImpl implements FileDataSource {
    ...
    private final String CREATE_USER_FILE_TABLE_SQL = "CREATE TABLE IF NOT EXISTS 'user_file' (" +
            ...
            ");";
    private final String SELECT_ALL_FILE_SQL = "SELECT * FROM user_file WHERE user_id = ?";
    private final String SELECT_FILE_SQL = "SELECT * FROM user_file WHERE user_id = ? AND file_name LIKE ? AND user_location LIKE ?";
    ...
    public List<StorageFile> getAllFiles(User user) {
        ...
        try(Connection connection = fileDbStorage.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(SELECT_ALL_FILE_SQL)){
    ...
    public List<StorageFile> getFiles(User user, String filename, String userLocation) {
        ...
        try(Connection connection = fileDbStorage.getConnection();
            ...
            preparedStatement.setString(3, userLocation);
            ResultSet resultSet = preparedStatement.executeQuery();
